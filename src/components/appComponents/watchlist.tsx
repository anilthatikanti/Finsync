...
const WatchList: React.FC = () => {
  ...
  const [updatedBtnLoading, setUpdatedBtnLoading] = useState<boolean>(false);
                      ...
                      >
                        {deleteBtnLoading ? (
                          <div role="status">
                            <svg
                              aria-hidden="true"
                              className="w-3 h-3 me-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                              viewBox="0 0 100 101"
                              fill="none"
                              xmlns="http://www.w3.org/2000/svg"
                            >
